...
typedef struct Ball
{
    ...
    Vector2 acceleration = {1, 1};  // Unused
    float radius;
    Color color;
    BallType type;
} Ball;
...
protected: // Can only be accessed through the Scene Manager via Update() per frame
    ...
    void init() override
    {
        ...
        hitSound = LoadSound("resources/ballPing.wav");
        ...
        {
        case MANUAL:
            TraceLog(LOG_INFO, "AI Type: MANUAL");
            break;
        
        case CONSTANT_SPEED:
            TraceLog(LOG_INFO, "AI Type: CONSTANT_SPEED");
            break;
        
        case MIRROR:
            TraceLog(LOG_INFO, "AI Type: MIRROR");
            break;

        case EASY:
            TraceLog(LOG_INFO, "AI Type: EASY");
            break;

        case MEDIUM:
            TraceLog(LOG_INFO, "AI Type: MEDIUM");
            break;

        case HARD: 
            TraceLog(LOG_INFO, "AI Type: HARD");
            break;
